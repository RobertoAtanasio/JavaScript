...
export class Database {
    ...
    // foi substituída a função e a Promise para arrow function a fim de quem o this
    // continue fazendo referência. Outra forma, seria usar o that = this
    // e substituir o this por that.
    execute(statement) {
        return new Promise((resolve, reject) => {
            setTimeout(() => {
                ...
                // o throw foi substituído pelo reject
